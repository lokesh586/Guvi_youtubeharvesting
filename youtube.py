...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBS7s0Ba9hPBsOJWrxQaFsDei7WTUPSxio"
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://lokesh586:monisha@cluster0.uv4gqjg.mongodb.net/?retryWrites=true&w=majority")
db = client["Youtube"]
